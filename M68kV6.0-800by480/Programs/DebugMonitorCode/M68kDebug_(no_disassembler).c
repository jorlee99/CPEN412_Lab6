...
#define addressStart 0x0800 0000 
...
void memorywrite(int pattern, int address, char datalength){
    // printf("Pattern is %x\n", pattern);
    unsigned int* int_mem_pointer;
    unsigned char* char_mem_pointer;
    unsigned short int* shortint_mem_pointer;
    ...
    if(address >= addressTestUpper || address < addressTestLower){
        ...
        if(datalength == (char)('B') || datalength == (char)('C')){ // need to check if the address is even or not
...
void memoryread(int address, char datalength){
    unsigned int* int_mem_pointer;
    unsigned char* char_mem_pointer;
    unsigned short int* shortint_mem_pointer;
